...
struct ObjectInstance : public Obj
{
    ...
    Value getProperty(const char* name) const { return getProperty(std::string(name)); }
    ...
    void setProperty(const char* name, Value value) { setProperty(std::string(name), value); }
