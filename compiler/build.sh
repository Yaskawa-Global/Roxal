...
#OPTS="-std=c++17 -fPIC -Wno-attributes -Werror=return-type -g -fmax-errors=1"
#OPTS="-std=c++17 -DDEBUG_BUILD -DDEBUG_TRACE_PARSE -DDEBUG_OUTPUT_PARSE_TREE -fPIC -Wno-attributes -Werror=return-type -g -fmax-errors=1"
