...
LIBS="-lantlr4-runtime cpp-gen/RoxalParserBase.a -licuio -licui18n -licuuc -licudata -lpthread -lboost_program_options -lprotobuf -lgrpc++ -lgrpc -lgpr -labsl_synchronization"
