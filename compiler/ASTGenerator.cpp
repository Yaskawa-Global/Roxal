...
{
    // auto astp = std::make_shared<AST>();
    // auto stmtp = std::make_shared<Statement>();

    // auto tvastp = typeValue(astp);
    // auto tvstmtp = typeValue(stmtp);

    // std::cout << tvastp.is<AST>() << std::endl;
    // std::cout << tvastp.is<Statement>() << std::endl;
    // std::cout << tvstmtp.is<AST>() << std::endl;
    // std::cout << tvstmtp.is<Statement>() << std::endl;

    // ptr<Statement> rstmt = tvstmtp.as<Statement>();
    // std::cout << (rstmt != nullptr) << std::endl;

    // std::cout << "----" << std::endl;

    // auto anyastp = antlrcpp::Any(astp);
    // auto anystmtp = antlrcpp::Any(stmtp);

    // std::cout << is<AST>(anyastp) << std::endl;
    // std::cout << is<AST>(anystmtp) << std::endl;
    // std::cout << is<Statement>(anystmtp) << std::endl;
    // std::cout << "----" << std::endl;

    // std::cout << anyastp.is<ptr<AST>>() << std::endl;
    // std::cout << anystmtp.is<ptr<AST>>() << std::endl;
    // std::cout << anystmtp.is<ptr<Statement>>() << std::endl;
    // std::cout << "----" << std::endl;


    // auto ast2 = AST();
    // auto stmt = Statement();
    // auto anyast = antlrcpp::Any(ast2);
    // auto anystmt = antlrcpp::Any(stmt);

    // std::cout << anyast.is<AST>() << std::endl;
    // std::cout << anystmt.is<AST>() << std::endl;
    // std::cout << anystmt.is<Statement>() << std::endl;
    // std::cout << "----" << std::endl;

    // auto astcp = &ast2;
    // auto stmtcp = &stmt;
    // auto anyastcp = antlrcpp::Any(astcp);
    // auto anystmtcp = antlrcpp::Any(stmtcp);

    // std::cout << anyastcp.is<AST*>() << std::endl;
    // std::cout << anystmtcp.is<AST*>() << std::endl;
    // std::cout << anystmtcp.is<Statement*>() << std::endl;
    // std::cout << "----" << std::endl;

    // AST* stmtastcp = &stmt;
    // std::cout << (dynamic_cast<AST*>(stmtcp) != nullptr) << std::endl;
    // std::cout << (dynamic_cast<AST*>(stmtastcp) != nullptr) << std::endl;

    // std::cout << (std::dynamic_pointer_cast<AST>(astp) != nullptr) << std::endl;
    // std::cout << (std::dynamic_pointer_cast<AST>(stmtp) != nullptr) << std::endl;

    // std::cout << "----" << std::endl;
    // std::any nanyast = ast2;
    // std::any nanystmt = stmt;
    // std::cout << nanyast.type().name() << std::endl;
    // std::cout << nanystmt.type().name() << std::endl;
    // std::cout << "----" << std::endl;

    // auto isASTcp = [](const std::any& a) {
    //     try {
    //         std::any_cast<AST*>(a);
    //         return true;
    //     } catch (...) { return false; }
    // };
    // auto isSTMTcp = [](const std::any& a) {
    //     try {
    //         std::any_cast<Statement*>(a);
    //         return true;
    //     } catch (...) { return false; }
    // };

    // std::any nanyastcp = &ast2;
    // std::any nanystmtcp = &stmt;
    // std::any nanyastcpstmt = (AST*)(&stmt);
    // std::cout << isASTcp(nanyastcp) << std::endl;
    // std::cout << isASTcp(nanystmtcp) << std::endl;
    // std::cout << isASTcp(nanyastcpstmt) << std::endl;
    // std::cout << isSTMTcp(nanystmtcp) << std::endl;
    // std::cout << isSTMTcp(nanyastcpstmt) << std::endl;
    // std::cout << "----" << std::endl;
