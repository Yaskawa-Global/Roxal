...
public:
    ...
    std::any visit(ptr<roxal::ast::JumpStatement> ast) override { if(m_f) m_f(ast); return{}; }
    std::any visit(ptr<roxal::ast::LabelStatement> ast) override { if(m_f) m_f(ast); return{}; }
