...
#define LV_DEF_REFR_PERIOD  16      /**< [ms]  (ms=1000/FPS ; 33=30FPS, 16=60FPS, ...) */
 ...
 * it should be enough to store the largest widget too (width x height x 4 area).
    * Set it to 0 to have no limit. */
    #define LV_DRAW_LAYER_MAX_MEMORY (2 * 1024 * 1024) //0  /**< No limit by default [bytes]*/
...
#if LV_USE_FS_POSIX
    #define LV_FS_POSIX_LETTER 'U'     /**< Set an upper-case driver-identifier letter for this driver (e.g. 'A'). */
