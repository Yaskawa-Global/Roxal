...
tests = [
    ...
    'signal_func_nocall', 'signal_func_exec', 'signal_index', 'signal_on_stmt', 'signal_on_threads', 'on_expression', 'signal_on_in_method', 'signal_on_changed_test', 'module_var_on_changed',
