...
tests = [
    ...
    'test_signal_value_property', 'construct_by_signal', 'signal_run_stop', 'signal_source', 'signal_named_param', 'signal_network1',
    ...
    'ffi1', 'ffi_addfloats', 'ffi_struct_out', 'ffi_inttypes', 'ffi_strlen', 'ffi_toupper', 'ffi_voidptr_struct', 'cstruct1', 'cstruct2', 'cstruct3', 'cstruct_byval',
