...
tests = [
    ...
    'dict', 'dict2', 'dict_keyerror', 'dict_dot', 'dict_dot_keyerror', 'list', 'list2', 'list_negative_index', 'copyinto_list', 'copyinto_list_unicode', 'copyinto_sublist', 'copyinto_signal', 'copyinto_signal_rewire',
