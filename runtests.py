...
tests = [
    ...
    'dict', 'dict2', 'dict_keyerror', 'dict_dot', 'dict_dot_keyerror', 'list', 'list2', 'copyassign_list', 'copyassign_sublist', 'copyassign_signal',
    ...
    'property_count', 'cmdline_execute', 'invalid_option', 'fileio_basic'
]
