...
tests = [
    ...
    'list_add_test', 'list_concat_shallow', 'list_methods', 'list_add_nonlist_err', 'list_remove_notfound_err', 'list_pop_empty_err', 'list_dict_equal', 'test_filter_map_reduce', 'list_method_exception', 'test_paren_continuation', 'range', 'range2', 'enum1', 'enum2', 'enum3', 'upvalue_leak',
