...
tests = [
    ...
    'unicode', 'dataflow1', 'signal_clock', 'signal_func_nocall', 'conversions1',
    'byteops',
    ...
    'threads1', 'actor1', 'actor2', 'actor3', 'actor4', 'actor5', 'actor6', 'actor7', 'actor8', 'actor9',
    ...
    'matrix1', 'matrix2', 'matrix_literal1', 'matrix_literal_newline', 'vector_matrix_negative', 'matrix_index', 'matrix_methods', 'matrix_assign', 'matrix_equal', 'ffi1', 'cstruct1', 'cstruct2'
]
