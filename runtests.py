...
tests = [
    ...
    'unicode', 'signal_clock', 'signal_func_nocall', 'signal_func_exec', 'test_signal_value_property', 'construct_by_signal', 'signal_run_stop',
    'dataflow_clocktest1', 'conversions1',
    'byteops',
